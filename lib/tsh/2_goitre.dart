...
class goitre_2 extends StatelessWidget {
  const goitre_2({super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("Avis de", style: StyleTexte.tspr),
            Text("l'endocrinologue :", style: StyleTexte.tspr),
            Text("recherche de goitre,", style: StyleTexte.tspr),
            Text("de nodule (clinique,", style: StyleTexte.tspr),
            Text("échographie)", style: StyleTexte.tspr),
