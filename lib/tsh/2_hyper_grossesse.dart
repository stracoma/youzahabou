...
import '2_T4_libre.dart';
import 'mes_styles/textes.dart';
import 'mes_styles/bouton.dart';
import '2_avis_endocrinologue.dart';

class Hyper_grossesse extends StatelessWidget {
  const Hyper_grossesse({super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("Grossesse", style: StyleTexte.tsgr),
                ...
                return ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const Endocrinologue_2(),
                      ),
                    );
                  },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const T4_libre_2()),
                );
              },
              style: AppButtonStyles.styleBtnRouge,
              child: const Column(
