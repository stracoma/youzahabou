...
import 'grossesse.dart';
import 'mes_styles/textes.dart';
import 'mes_styles/bouton.dart';

class Hypothyr extends StatelessWidget {
  const Hypothyr({super.key});
          ...
          children: [
                ...
                return ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const Grossesse(),
                      ),
                    );
                  },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Reversibles()),
                );
              },
              style: AppButtonStyles.styleBtnVert,
              child: const Column(
