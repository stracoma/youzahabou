...
import 't4libre.dart';
import 'hypoaveree.dart';

class Tsh20 extends StatelessWidget {
  const Tsh20({super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("TSH > 20", style: StyleTexte.tsgv),
                ...
                return ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const Hypoaveree(),
                      ),
                    );
                  },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const T4libre()),
                );
              },
              style: AppButtonStyles.styleBtnVert,
              child: const Column(
