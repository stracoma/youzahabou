...
class Epreuve extends StatelessWidget {
  const Epreuve({super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("Envisager un", style: StyleTexte.tsgv),
            Text("traitement", style: StyleTexte.tsgv),
            Text("d'épreuve", style: StyleTexte.tsgv),
