...
class Suivi1an extends StatelessWidget {
  const Suivi1an({super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("Suivi une fois par", style: StyleTexte.tspv),
            Text("an ou éventuellement", style: StyleTexte.tspv),
            Text("envisager traitement", style: StyleTexte.tspv),
