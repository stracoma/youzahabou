...
import 'tsh_sup_10.dart';
import 'mes_styles/textes.dart';
import 'mes_styles/bouton.dart';
import 'anti_tpo.dart';

class Subclinique extends StatelessWidget {
  const Subclinique({super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("Hypothyroïdie", style: StyleTexte.tsgv),
            Text("subclinique", style: StyleTexte.tsgv),
            Text('Clinique compatible ?', style: StyleTexte.tspv),
                ...
                return ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const Tsh_sup_10(),
                      ),
                    );
                  },
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const AntiTPO()),
                );
              },
              style: AppButtonStyles.styleBtnVert,
              child: const Column(
