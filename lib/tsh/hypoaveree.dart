...
class Hypoaveree extends StatelessWidget {
  const Hypoaveree({super.key});
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("avérée", style: StyleTexte.tsgv),
            Text("Traitement substitutif", style: StyleTexte.tspv),
            Text("par Lévothyrox", style: StyleTexte.tspv),
